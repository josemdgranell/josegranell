(()=>{
 ...
 const bubble=document.createElement('div');bubble.id='lofi-dialogue';bubble.className='lofi-dialogue';bubble.hidden=true;bubble.setAttribute('role','group');bubble.setAttribute('aria-labelledby','lofi-dialogue-title');bubble.innerHTML='<span class="dialogue-speaker">A FRIENDLY TRAVELLER</span><p id="lofi-dialogue-title">Looking for a little hidden lore about me?</p><div class="dialogue-choices"><button type="button" class="dialogue-yes">Yes, tell me <svg class="ui-arrow" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M6 18 18 6M6 6h12v12"/></svg></button><button type="button" class="dialogue-later">Another time</button></div>';mascot.closest('.lofi-player').append(bubble);
